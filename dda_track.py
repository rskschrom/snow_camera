...
for i in range(nt+1):
    # simulate image
    print i
    ax, ay, pf = fm.cam_pixel_dipoles(sx, sy, sz, fov, fov, lens_w, lens_w, nw, nh)
    ...
    sx, sy, sz = cant(sx, sy, sz, np.pi/nt*cant_max*np.cos(i*np.pi/nt), 0.)
